                ...
                <div className="absolute inset-0 flex items-end">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 w-full pb-10 lg:pb-14">
                        ...
                        >
                            ...
                            <Link href="/dau-cnc/tin-tuc" className="hover:text-primary transition-colors">Tin tức</Link>
                            <ChevronRight className="w-3 h-3" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                        ...
                        <aside className="lg:col-span-4 space-y-8 lg:sticky top-24 self-start">
                            ...
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
                                <Link href="/dau-cnc/tin-tuc" className="group inline-flex items-center gap-2 text-sm font-bold text-primary hover:text-primary/80 transition-colors">
