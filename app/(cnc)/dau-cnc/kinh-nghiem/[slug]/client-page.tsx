                ...
                <div className="absolute inset-0 flex items-end">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 w-full pb-10 lg:pb-14">
                        ...
                        >
                            ...
                            <Link href="/dau-cnc/kinh-nghiem" className="hover:text-primary transition-colors">Kinh nghiệm</Link>
                            <ChevronRight className="w-3 h-3" />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  ...
                  prose-a:text-primary prose-a:no-underline hover:prose-a:underline"
                            ...
                            <div className="mt-12 pt-8 border-t border-white/10 flex items-center justify-between">
                                <Link href="/dau-cnc/kinh-nghiem" className="text-sm font-bold text-white/40 hover:text-primary transition-colors flex items-center gap-2">
