                        ...
                        <div className="space-y-8">
                            ...
                            >
                                ...
                                <ul className="space-y-1 relative">
                                    {categories.map((cat) => (
                                        <li key={cat.name}>
                                            <Link href="/dau-co-khi/tin-tuc" className="flex items-center justify-between py-3 px-3 rounded-xl hover:bg-white/5 text-white/50 hover:text-white transition-all text-sm group">
